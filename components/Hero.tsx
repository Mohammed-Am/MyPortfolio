        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-4 sm:gap-12 lg:gap-8 w-full max-w-6xl mx-auto">
          ...
          <div className="w-full lg:w-1/2 flex justify-center lg:justify-start">
            <div className="relative flex items-center justify-center mx-auto lg:mx-0">
              <div className="relative w-40 h-40 sm:w-64 sm:h-64 rounded-full overflow-hidden border-2 border-emerald-500/50 shadow-[0_0_60px_rgba(16,185,129,0.3)] bg-slate-100 dark:bg-gray-800">
                <Image
                  src="/profil.jpg"
